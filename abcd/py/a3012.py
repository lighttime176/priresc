...
def b4(tab,browser):
    ...
    time.sleep(1)
    ele = tab.ele('css=body > div > div > header.fixed.top-0.z-40.w-full.bg-background > div.flex.h-16.items-center.w-full.px-\[130px\] > div > div > button.Header_buttonStyle__WagzW')
    ele.click(by_js=True)
...
def setup_logger(log_filename="logs/a3012.log", log_level=logging.DEBUG):
    """
